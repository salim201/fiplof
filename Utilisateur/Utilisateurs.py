...
# Form implementation generated from reading ui file 'Utilisateurs.ui'
#
# Created: Sat Dec 15 00:51:11 2018
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButtonPrivileges = QtGui.QPushButton(Dialog)
        self.pushButtonPrivileges.setEnabled(False)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/users/icone/group.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButtonPrivileges.setIcon(icon3)
        self.pushButtonPrivileges.setObjectName(_fromUtf8("pushButtonPrivileges"))
        self.verticalLayout.addWidget(self.pushButtonPrivileges)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/std/icone/if_minus_10199.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButtonSupprimer.setIcon(icon4)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Liste Des Utilisateurs", None))
        ...
        self.pushButtonPrivileges.setText(_translate("Dialog", "Privilèges", None))
