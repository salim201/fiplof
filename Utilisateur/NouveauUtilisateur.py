...
# Form implementation generated from reading ui file 'NouveauUtilisateur.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(363, 390)
        self.groupBox_2 = QtGui.QGroupBox(Dialog)
        self.groupBox_2.setGeometry(QtCore.QRect(10, 10, 341, 311))
        ...
        self.Valider = QtGui.QPushButton(Dialog)
        self.Valider.setGeometry(QtCore.QRect(220, 350, 61, 23))
        self.Valider.setObjectName(_fromUtf8("Valider"))
        self.Fermer = QtGui.QPushButton(Dialog)
        self.Fermer.setGeometry(QtCore.QRect(290, 350, 61, 23))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.Valider.setText(_translate("Dialog", "Valider", None))
