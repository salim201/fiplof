...
from ImporterThread import ImporterThread
from Utils import Utils


class importPLOF(QtGui.QDialog):
    ...
    def initSteps(self):
        ...
        del self.substeps[:]
        for i in ["Certificats", "Parcelles", "Personnes Physiques", "Liaison Certificat/Demande", "Demandes", "Proprio (temporaires)" , "Demandeurs","Proprietaires", "Voisins"]:
