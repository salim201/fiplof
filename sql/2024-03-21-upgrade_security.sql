...
UPDATE groupe SET nom = 'Responsable Commune', description = ' Responsable des communes' WHERE id = 5;
INSERT INTO groupe VALUES (10, 'Guichet Foncier', ' Agent Guichet Foncier');
UPDATE groupe SET nom = 'Guichet Foncier', description = ' Agent Guichet Foncier' WHERE id = 10;
INSERT INTO groupe VALUES (11, 'Assistants Techniques', 'Assistants Techniques ');
UPDATE groupe SET nom = 'Assistants Techniques', description = 'Assistants Techniques ' WHERE id = 11;
INSERT INTO groupe VALUES (12, 'Formateur', ' Formateur');
UPDATE groupe SET nom = 'Formateur', description = ' Formateur' WHERE id = 12;
INSERT INTO groupe VALUES (13, 'Guichet Unique (TOPO)', ' TOPO pour mise à jour PLOF');
UPDATE groupe SET nom = 'Guichet Unique (TOPO)', description = ' TOPO pour mise à jour PLOF' WHERE id = 13;
INSERT INTO groupe VALUES (14, 'Disposition Transitoire', ' Disposition Transitoire');
UPDATE groupe SET nom = 'Disposition Transitoire', description = ' Disposition Transitoire' WHERE id = 14;


SELECT pg_catalog.setval('groupe_id_seq', 14, true);


UPDATE utilisateur SET  nomutilisateur = 'Responsable', prenomutilisateur =  'Commune', loginutilisateur = 'respcom', passwordutilisateur = '0308BD47138299D52D9A197C3D2178DD', telephone = '034', groupe_id = 5 WHERE idutilisateur = 8;

INSERT INTO utilisateur VALUES (10, 'Assistant', 'Technique', 'ats', '34EE78AE5EDC56DC1DC00BB844C5D62A', NULL, '', '', '', NULL, NULL, 11);
UPDATE utilisateur SET  nomutilisateur = 'Assistant', prenomutilisateur =  'Technique', loginutilisateur = 'ats', passwordutilisateur = '34EE78AE5EDC56DC1DC00BB844C5D62A', telephone = '034', groupe_id = 11 WHERE idutilisateur = 10;
INSERT INTO utilisateur VALUES (11, 'Formateur', '', 'formation', '06048D2F2D2CA345A721B4FD25B91A92', NULL, '', '', '', NULL, NULL, 12);
UPDATE utilisateur SET  nomutilisateur = 'Formateur', loginutilisateur = 'formation', passwordutilisateur = '06048D2F2D2CA345A721B4FD25B91A92', telephone = '034', groupe_id = 12 WHERE idutilisateur = 11;
INSERT INTO utilisateur VALUES (12, 'Agent', 'Topo', 'topo', '1D6EA1F692424E806963838CF9E37E37', NULL, '', '', '', NULL, NULL, 13);
UPDATE utilisateur SET  nomutilisateur = 'Agent', prenomutilisateur =  'Topo', loginutilisateur = 'topo', passwordutilisateur = '1D6EA1F692424E806963838CF9E37E37', telephone = '034', groupe_id = 13 WHERE idutilisateur = 12;
INSERT INTO utilisateur VALUES (13, 'Disposition', 'Transitoire', 'dt', '13D94D956F809706C5245ABD927A0E15', NULL, '', '', '', NULL, NULL, 14);
UPDATE utilisateur SET  nomutilisateur = 'Disposition', prenomutilisateur =  'Transitoire', loginutilisateur = 'dt', passwordutilisateur = '13D94D956F809706C5245ABD927A0E15', telephone = '034', groupe_id = 14 WHERE idutilisateur = 13;
INSERT INTO utilisateur VALUES (14, 'Agent', 'Guichet Foncier', 'agf', 'A3856373041BB18DD4A9943A55B4D654', NULL, '', '', '', NULL, NULL, 10);
UPDATE utilisateur SET  nomutilisateur = 'Agent', prenomutilisateur =  'Guichet Foncier', loginutilisateur = 'agf', passwordutilisateur = 'A3856373041BB18DD4A9943A55B4D654', telephone = '034', groupe_id = 10 WHERE idutilisateur = 14;

UPDATE utilisateur SET  nomutilisateur = 'Administrateur', prenomutilisateur =  'Fiplof', loginutilisateur = 'admin', passwordutilisateur = 'EC40092C49C76E8EA3A8AA7F7FA9B0EB', telephone = '034', groupe_id = 1 WHERE idutilisateur = 1;
