...
from Projet.ImportDb import Ui_Dialog
from ImporterThreadFromField import ImporterThreadFromField
from Utils import Utils
import sys


class ImporterFromField(QtGui.QDialog):
    ...
    def initSteps(self):
        ...
        for i in ["Personnes Physiques", "Localites", "Demandes", "Codemandeurs"]:
    ...
    def browseFile(self):
        ...
        try:
            self.filename = QtGui.QFileDialog.getOpenFileName(self,"Choisir un fichier xls", "", u"Fichiers Excel (*.xls)")
    ...
    def launch(self):
        ...
        self.myThread = ImporterThreadFromField(filename=self.filename, connection=self.connection)
