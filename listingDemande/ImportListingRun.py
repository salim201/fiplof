...
from .ImportListingDemande import Ui_Dialog

from ImportListingThread import ImportListingThread
...
class ImportListingRun(QDialog):
    ...
    def initSteps(self):
        ...
        if self.ui.checkBoxListing.isChecked():
            self.steps.append(u"Listing Demande")
    ...
    def launch(self):
        ...
        self.myThread = ImportListingThread(filenames=self.fileNames, connection=self.connection, refimport = self.refImport, steps = self.steps, idfkt=idfokontany, region=region)
