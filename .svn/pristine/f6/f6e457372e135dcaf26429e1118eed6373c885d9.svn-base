...
# Form implementation generated from reading ui file 'ActePrive.ui'
#
# Created: Sat Apr 07 17:55:54 2018
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.dateEditLegalisationSignature = QtGui.QDateEdit(self.frame)
        self.dateEditLegalisationSignature.setCalendarPopup(True)
        self.dateEditLegalisationSignature.setObjectName(_fromUtf8("dateEditLegalisationSignature"))
        self.gridLayout.addWidget(self.dateEditLegalisationSignature, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QtGui.QApplication.translate("Dialog", "Acte privé", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.nomDeLOfficierPublicLabel.setText(QtGui.QApplication.translate("Dialog", "Date de légalisation signature*", None, QtGui.QApplication.UnicodeUTF8))
