...
# Form implementation generated from reading ui file 'PopupInfosTSS.ui'
#
# Created: Tue Mar 19 15:22:49 2024
...
class Ui_INFORMATIONS(object):
    def setupUi(self, INFORMATIONS):
        ...
        self.fn_fg = QtGui.QLineEdit(INFORMATIONS)
        self.fn_fg.setObjectName(_fromUtf8("fn_fg"))
        self.gridLayout.addWidget(self.fn_fg, 0, 1, 1, 1)
        ...
        self.demandeur = QtGui.QLineEdit(INFORMATIONS)
        self.demandeur.setObjectName(_fromUtf8("demandeur"))
        self.gridLayout.addWidget(self.demandeur, 1, 1, 1, 1)
        ...
        self.obs = QtGui.QLineEdit(INFORMATIONS)
        self.obs.setObjectName(_fromUtf8("obs"))
        self.gridLayout.addWidget(self.obs, 3, 1, 1, 1)
    ...
    def retranslateUi(self, INFORMATIONS):
        ...
        self.label_7.setText(_translate("INFORMATIONS", "FN_FG", None))
        self.label_4.setText(_translate("INFORMATIONS", "OBSERVATION", None))
        self.label_5.setText(_translate("INFORMATIONS", "SUR_PLAN", None))
        self.label_6.setText(_translate("INFORMATIONS", "DEMANDEUR", None))
