...
class ImportListingThread(QThread):
    def __init__(self, filenames, connection, refimport = 0, steps = None, idfkt = 0, idham = None, region = ''):
        ...
        self.idHam = idham
        self.region = region
        self.logger = xlsLogger.xlsLogger("Import_Listing_Demande")
    ...
    def run(self):
        ...
        for step in self.steps:
            if str(step).strip() == u"Listing Demande":
                #IMPORT listing
                ...
                if line >= 1:
                    ...
                    if nomCommuneFromDb is None:
                        ...
                        #Check Hameau
                            ...
                            dataPersonne['nompere'] = str(sh_demande.cell_value(line, 29)).strip().replace("'","\'").decode('utf-8')
                            dataPersonne['nommere'] = str(sh_demande.cell_value(line, 30)).strip().replace("'","\'").decode('utf-8')
                            dataPersonne['lieunaissance'] = str(sh_demande.cell_value(line, 32)).strip().replace("'","\'").decode('utf-8')
                            matrimoniale = str(sh_demande.cell_value(line, 31)).strip().replace("'","\'").decode('utf-8')
                            dataPersonne['matrimoniale'] = 1
                            if matrimoniale == "ENY":
                                dataPersonne['matrimoniale'] = 2
                ...
                if data['num_pi'] != '':
                    ...
                    try:
                        ...
                        cursor.execute('UPDATE personne SET nompersonne = %s, prenompersonne = %s, sexepersonne = %s, '
                                       ...
                                       'datecipersonne = %s, lieucipersonne = %s,  adressepersonne = %s, situationmatrimoniale = %s, nompere = %s, nommere = %s, lieunaissancepersonne = %s '
                                       ' where idpersonne = %s',
                                       (nom, prenoms, sexe, data['date_naissance'], data['nevers'], data['num_pi'],
                                        data['date_pi'], data['lieu_pi'],
                                        data['adresse'],data['matrimoniale'],data['nompere'],data['nommere'], data['lieunaissance'], str(idpers)))
                        self.connection.commit()
                        ...
                        if result is not None:
                            ...
                            try:
                                ...
                                cursor.execute('UPDATE personne SET nompersonne = %s, prenompersonne = %s, sexepersonne = %s, '
                                               ...
                                               'dateactenaissancepersonne = %s, lieuactenaissancepersonne = %s,  adressepersonne = %s, situationmatrimoniale = %s, nompere = %s, nommere = %s, lieunaissancepersonne = %s '
                                               ' WHERE idpersonne = %s',
            ...
            if data['num_pi'] != '':
                ...
                try:
                    ...
                    cursor.execute('INSERT INTO personne (nompersonne, prenompersonne, sexepersonne, '\
                                   ...
                                   'datecipersonne, lieucipersonne,  adressepersonne, situationmatrimoniale, nompere, nommere, lieunaissancepersonne'\
                                   ') VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s) returning idpersonne',
                                   (nom, prenoms, sexe, data['date_naissance'], data['nevers'], data['num_pi'], data['date_pi'], data['lieu_pi'],
                                    data['adresse'],data['matrimoniale'],data['nompere'],data['nommere'],data['lieunaissance']))
                    self.connection.commit()
                    ...
                    if result is not None:
                        ...
                        try:
                            ...
                            cursor.execute('INSERT INTO personne (nompersonne, prenompersonne, sexepersonne, '\
                                           ...
                                           'dateactenaissancepersonne, lieuactenaissancepersonne,  adressepersonne, situationmatrimoniale, nompere, nommere, lieunaissancepersonne'\
                                           ') VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s) returning idpersonne',
