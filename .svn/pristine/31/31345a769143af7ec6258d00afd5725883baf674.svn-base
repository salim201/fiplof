...
# ******************FIN FONCTIONS UTILES A LA PAGINATION ************************#
    ...
    def doPrint(self):
        ...
        for idDmdtoPrint in self.idsDmdtoPrint:
            ...
            try:
                self.cur.execute("SELECT dmd.numdemande, dmd.datedemande, pd.gid, pd.idhameau, pd.id_commune, dmd.datedecision, dmd.consistance, dmd.categorie, dmd.numdecision, dmd.datereconnaissance FROM demande dmd, parcelle_d pd WHERE dmd.gid = pd.gid AND dmd.iddemande = %s", (idDmdtoPrint,))
