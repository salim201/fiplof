...
class DtSplitFeature(DtSingleEditTool):
    '''Split feature'''
    def __init__(self, iface,parent,current_layer,canvas):
        self.parent = parent
        self.iface = iface
        self.canvas  = canvas
        ...
        print "DtSplitFeature IN"
        print current_layer
        print "DtSplitFeature OUT"
        self.editLayer = None
        self.crsWarning = True

        #DtSingleEditTool.__init__(self,iface,self.MainWindow,self.current_layer,
        #   QtGui.QIcon(":/splitfeature.png"),
        #    QtCore.QCoreApplication.translate("digitizingtools", "Split Features"),
        #    geometryTypes = [2, 3, 5, 6])
        self.geometryTypes =  [2, 3, 5, 6]
        self.tool = DtSplitFeatureTool(self.iface,self.geometryTypes,self.current_layer,self.canvas,self)
            ...
            for anId, aFeat in list(featuresToSplit.items()):
                ...
                for thisGeom in geomsToSplit:
                    try:
                        ...
                        self.msgBar.pushMessage("Succes", dtutils.dtGetErrorMessage(),
                        ...
                        while takeThisOne == -1:
                            for i in range(len(splitResult)):
                                ...
                                answer = QMessageBox.question(
                                    ...
                                    QMessageBox.Yes | QMessageBox.No | QMessageBox.Cancel | QMessageBox.NoToAll)
    ...
    def process(self):
        ...
        self.editLayer = self.current_layer
