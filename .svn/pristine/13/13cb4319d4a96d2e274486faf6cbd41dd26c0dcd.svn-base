...
from CorrectionOccupantThread import CorrectionOccupantThread
...
class CorrectionOccupantRun(QDialog):
    def __init__(self, connection):
        ...
        self.ui.checkBoxLocalite.setChecked(False)
        self.ui.checkBoxOccupant.setChecked(True)
        self.ui.checkBoxPersonne.setChecked(True)
        self.ui.checkBoxParcelle.setChecked(False)
        self.ui.checkBoxFichierForme.setChecked(False)
        ###### hide all tsy ilaina
        self.ui.label_5.hide()
        self.ui.checkBoxParcelle.hide()
        self.ui.label.hide()
        self.ui.lineEditParcelles.hide()
        self.ui.toolButtonPrcourir_parcelle.hide()
        self.ui.checkBoxLocalite.hide()
        self.ui.label_4.hide()
        self.ui.lineEditLocalites.hide()
        self.ui.toolButtonParcourir_localite.hide()
        self.ui.label_6.hide()
        self.ui.lineEditRefImport.hide()
        ...
        self.setWindowTitle("Correction Automatique Occupant")
        self.initSteps()
    ...
    def launch(self):
        ...
        self.myThread = CorrectionOccupantThread(filenames=self.fileNames, connection=self.connection, refimport = self.refImport, steps = self.steps)
