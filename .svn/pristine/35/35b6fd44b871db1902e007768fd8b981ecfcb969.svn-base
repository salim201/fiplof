...
from ImportHameau import Ui_Dialog
from ImporterThreadHameau import ImporterThreadHameau
from Utils import Utils
import sys


class ImporterHameau(QtGui.QDialog):
    ...
    def initSteps(self):
        ...
        for i in ["Fokontany","Hameau","Consistance"]:
    ...
    def launch(self):
        ...
        self.myThread = ImporterThreadHameau(filename=self.filename, connection=self.connection)
