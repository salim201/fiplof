...
from ImporterThreadFi import ImporterThread
from Utils import Utils
import ogrinfo
import sys


class importFIPLOF(QtGui.QDialog):
    def __init__(self, connection):
        QtGui.QDialog.__init__(self)
        self.ui = Ui_Dialog()
        self.ui.setupUi(self)
        self.setWindowTitle(u"Import de données FIPLOF")
        self.initAction()
    ...
    def initSteps(self):
        ...
        del self.substeps[:]
        for i in ["Parcelles", "Contribuables","Liaison parcelle / cintribuable", "Impots", "Parametres" ]:
