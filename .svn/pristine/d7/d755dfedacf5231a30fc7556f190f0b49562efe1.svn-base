...
from AutoBackupThread import AutoBackupThread
...
class AutoBackupRun(Qt.QDialog):
    def __init__(self,parent,connection, exetype='pg_dump'):
    ...
    def launch(self):
        ...
        try:
            self.myThread = AutoBackupThread(pgdump=pgdump, dirname=self.dirname, connection=self.connection, parent = self)
    ...
    def termine(self):
        ...
        QtGui.QMessageBox.information(
            self,
            "Termine",
            "L'export automatique de la base est termine" if self.type == "pg_dump" else
