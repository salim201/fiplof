...
class DigitizingTools:
    ...
    def __init__(self, iface,parent):
        ...
        self.current_layer = self.parent.cLayer
...
#        self.medianLine = dtmedianline.DtMedianLine(self.iface, self.toolBar)
        try :
            self.splitfeature = dtsplitfeature.DtSplitFeature(self.iface)
    ...
    def splitFeature(self):
        ...
        print  "splitFeature in"
        print  self.current_layer
        print " type layer in"
        print self.current_layer.type()
        self.typeOp = self.parent.typeOp
        self.idActe = self.parent.idActe
        try:
            self.splitfeature = dtsplitfeature.DtSplitFeature(self.iface,self.parent,self.current_layer,self.canvas)
        except Exception as e:
            print(e)
    def doAbout(self):
