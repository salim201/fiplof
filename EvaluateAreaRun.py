...
from evaluateArea import Ui_Dialog
...
class EvaluateAreaRun(Qt.QDialog):
  def __init__(self):
    ...
    #self.tool = MultipleLayersEditNodesButton(self.iface, self.canvas, self)
  ...
  def getFeatureInfos(self):
      ...
      cursor.execute("SELECT pd.gid,pd.numdemande,d.datedemande,pd.surface,d.nomdemandeur,cf.numerocertificat,fkt.nomfokontany,hm.nomhameau"
                     " FROM parcelle_d pd  "
